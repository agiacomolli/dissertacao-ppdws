...
encontradas na \cref{sub:proposta-gerenciador-analises}.\todo[color=green]{explicação está muito
suscinta e deve ser ampliada (deves explicar melhor capítulo anterior e neste capítulo basicamente
referenciar a explicação já feita). Esta é uma parte importante da tua dissertação}
...
para os algoritmos presentes no software Watchdog Agent, versão 3.3\todo[color=green]{referencia}.
...
\todo[inline, color=green]{antes de iniciar esta sub-seção creio que seria importante apresentares
algumas métricas de implementação, tais como número e tamanho dos programas criados, eventualmente
apresentar o código de alguns módulos (e creio que poderia colocar mais códigos nos anexos, para que
aqueles "curiosos" em ver como isto foi implementado possam ter acesso)}
