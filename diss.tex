...
\definecolor{table-green}{rgb}{0.07,0.5,0.18}
...
\begin{onehalfspace}
  ...
  \input{chapters/conceituacao-teorica}
  \input{chapters/analise-estado-arte}
  %\input{chapters/arquiteturas-orientadas-servicos}
  \input{chapters/arquitetura-proposta}
  \input{chapters/implementacao-resultados}
